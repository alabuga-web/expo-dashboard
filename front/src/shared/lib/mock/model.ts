...
export const EQUIPMENT: Equipment[] = [
  { id: "EQ_PLC", name: "ПЛК / Factory I/O", type: "контроллер", zoneId: "Z01", status: "running", cycleTimeSec: 0, throughputPerMin: 0 },
  ...
  { id: "EQ_Z04_PP", name: "FX5 Pick & Place", type: "манипулятор", zoneId: "Z04", status: "running", cycleTimeSec: 2.2, throughputPerMin: 28 },
